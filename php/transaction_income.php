...
<body>
  <div class="container transaction-container">
    ...
    <h2 class="title-page">Add Income</h2>

    <form id="incomeForm" method="post" action="add_income.php" class="transaction-form" onsubmit="submitIncome(event);">

      <label class="form-label">Income source
        <input type="text" name="income_source" required maxlength="100" class="input-text">
      </label>
      ...
      <label class="form-label">Received from
        <input type="text" name="received_from" maxlength="100" class="input-text">
      </label>
